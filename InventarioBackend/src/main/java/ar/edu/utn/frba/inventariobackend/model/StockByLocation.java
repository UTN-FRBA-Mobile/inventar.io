...
@Getter
@Entity
@Table(name = "stock_by_location", uniqueConstraints = {@UniqueConstraint(columnNames = {"id_product", "id_location"})})
public class StockByLocation {
	...
	/**
	 * A string describing a more specific location within the main location (e.g.,
	 * aisle, shelf, bin).
	 */
	 ...
	 *            the stock quantity
	 * @param innerLocation
	 *            a specific sub-location string
	 */
	 ...
	 * 
	 * @param stock
	 *            The value to reduce from the existing stock.
	 */
	 ...
	 * 
	 * @param stock
	 *            The value to add from the existing stock.
	 */
