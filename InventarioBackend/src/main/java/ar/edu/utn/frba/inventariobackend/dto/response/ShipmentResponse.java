 ...
 * @param status           The current state of the shipment.
 * @param creationDate     The date and time when the shipment was created.
 * @param lastModifiedDate The date and time when the shipment was last modified.
