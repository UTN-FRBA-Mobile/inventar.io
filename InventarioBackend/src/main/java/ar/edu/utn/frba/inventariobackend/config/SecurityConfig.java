...
/**
 * Configures security settings for the application, including route protection
...
public class SecurityConfig {
	 ...
	 *
	 * @param http
	 *            the {@link HttpSecurity} object used to configure web-based
	 *            security.
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		return http.csrf(AbstractHttpConfigurer::disable)
				...
				.authorizeHttpRequests(auth -> auth
						.requestMatchers("/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html", "/api/v1/products/",
								"/api/v1/auth/login", "/api/v1/auth/refresh", "/api/v1/user", "/api/v1/location",
								"/api/v1/shipments", "/api/v1/orders", "/api/v1/products", "/api/v1/products/stock")
