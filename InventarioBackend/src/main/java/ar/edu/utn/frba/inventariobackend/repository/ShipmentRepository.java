...
/**
 * Repository interface for performing CRUD operations on {@link Shipment}
 * entities.
 * <p>
 * Extends {@link JpaRepository} to inherit methods for saving, deleting, and
 * finding {@link Shipment} entities by their ID or other criteria.
 * </p>
 */
@Repository
