...
public class AuthenticationController {
     ...
     *
     * @param request the login request containing username, password, latitude, and longitude
     * @return a {@link ResponseEntity} containing access and refresh tokens, or error if login fails
     */
    @PostMapping("/login")
    public ResponseEntity<?> login(@Valid @RequestBody LoginRequest request) {
        ...
        Optional<LocationResponse> location =
            locationService.getLocationByPosition(request.latitude(), request.longitude());
