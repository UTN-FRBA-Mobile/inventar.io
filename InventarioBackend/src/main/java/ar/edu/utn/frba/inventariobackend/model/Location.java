...
public class Location {
     ...
     *
     * @param latitude  the latitude coordinate, between -90 and 90
     * @param longitude the longitude coordinate, between -90 and 90
     * @param radius    the radius around the location (must be positive)
