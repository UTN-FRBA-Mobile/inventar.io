...
/**
 * REST controller for managing user-related operations. Provides endpoints for
 * registering and retrieving user information.
 */
@RestController
...
public class UserController {
	 ...
	 *            the request containing user details such as username, password,
	 *            name, and optional image
	 * @return a {@link ResponseEntity} with HTTP 201 Created status if the user was
	 *         successfully added
	 */
	@PostMapping()
	 ...
	 *             if the user is not found (HTTP 404 Not Found)
	 */
