...
/**
 * Represents an outgoing shipment of products. Shipments are not primarily
 * managed via QR code scanning for initiation.
 */
@Getter
@Entity
@Table(name = "shipment")
public class Shipment {
	 ...
	 *
	 * @param status
	 *            the initial state of the shipment
	 * @param creationDate
	 *            the creation date
	 ...
	 */
	public Shipment(Status status, LocalDateTime creationDate, LocalDateTime lastModifiedDate, Long idLocation,
			String customerName) {
		this.status = status;
