...
/**
 * Represents a line item within an Order, detailing a specific product and its
 * quantity. This acts as a join table between Orders and Product with an
 * additional 'amount' attribute.
 */
@Getter
@Entity
...
public class ItemByOperation {
	...
	/**
	 * The quantity of the product requested in this operation item. Originally
	 ...
	 *
	 * @param idOperation
	 *            the id of the operation this item belongs to
	 * @param idProduct
	 *            the product in this item
	 * @param itemType
	 *            the type of item (shipment or order)
	 * @param amount
