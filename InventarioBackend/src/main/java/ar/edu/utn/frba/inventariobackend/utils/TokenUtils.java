...
/**
 * Utility class for extracting user-related information from the Spring Security context.
 * Primarily used for accessing custom authentication details such as username and location ID
...
public class TokenUtils {
    ...
    /**
     * Retrieves the location ID of the currently authenticated user from the security context.
     *
     * @return the location ID associated with the current authentication
     * @throws ResponseStatusException if authentication is not present or details are invalid (HTTP 403)
     */
    ...
    /**
     * Helper method to retrieve the current {@link Authentication} object from the security context.
     *
     * @return the current {@link Authentication} object
     * @throws ResponseStatusException if authentication is not found or invalid (HTTP 403)
     */
