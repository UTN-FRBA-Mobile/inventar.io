...
public interface StockByLocationRepository extends JpaRepository<StockByLocation, Long> {
    /**
     * Finds StockByLocation entities where idProduct is in the given list
     * and idLocation matches the single provided location ID.
     * @param idProducts A list of product IDs.
     * @param idLocation The single location ID.
